...
/*!40101 SET character_set_client = @saved_cs_client */;
ALTER TABLE ipl_bidding_details 
ADD FOREIGN KEY (BID_TEAM) REFERENCES ipl_team(team_id) ON DELETE CASCADE;
--
...
ADD FOREIGN KEY (match_winner) REFERENCES ipl_team(team_id) ON DELETE CASCADE;
--
...
ADD FOREIGN KEY (PLAYER_ID) REFERENCES ipl_player(PLAYER_ID) ON DELETE CASCADE;
--
...
/*!40101 SET character_set_client = @saved_cs_client */;
ALTER TABLE ipl_team_players
ADD FOREIGN KEY (team_id) REFERENCES ipl_team(team_id) ON DELETE CASCADE;
--
